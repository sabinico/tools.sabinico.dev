<template>
  ...
  >
    ...
    >
      &copy; 1995-{{ (new Date()).getFullYear() }} <span class="d-none d-sm-inline-block">Sabinico</span>
    </div>
  </v-footer>
</template>
  ...
  const items = [
    {
      ...
      href: 'https://x.com/Sabinico',
    },
    {
      title: 'Sabinico GitHub',
      icon: `mdi-github`,
      href: 'https://github.com/sabinico',
    },
    {
      title: 'SABICORP Discord',
